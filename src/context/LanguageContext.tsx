...
const tr: Record<string, string> = {
  ...
  "trust.return": "14 Gün İade",
  "trust.returnDesc": "Koşulsuz iade hakkı",
  "trust.shipping": "Ücretsiz Kargo",
  "trust.shippingDesc": "500₺ ve üzeri alışverişte",
  "trust.secure": "Güvenli Ödeme",
  "trust.secureDesc": "256-bit SSL, iyzico altyapısı",

  // Why ComicWall
  "why.badge": "Fark Yaratıyoruz",
  "why.title": "Neden ComicWall?",
  "why.desc": "Sadece poster satmıyoruz. Her kare, özgün bir sanat eseri — müze kalitesinde basılmış, güvenle paketlenmiş, kapınıza kadar getirilmiş.",
  "why.ai.title": "Orijinal AI Tasarım",
  "why.ai.desc": "Her eser yapay zeka ile ComicWall tarafından özgün olarak üretilir. Hiçbir telifli karakter veya içerik kullanılmaz.",
  "why.quality.title": "Müze Kalitesi Baskı",
  "why.quality.desc": "250 gsm mat fotoğraf kağıdı ve pigment mürekkep. Yıllarca solmaz, zamanla değer kazanır.",
  "why.fast.title": "Hızlı Teslimat",
  "why.fast.desc": "Ödeme onayından 1–2 iş günü içinde kargoya verilir. Tüm Türkiye'ye kapıya teslimat.",
  "why.secure.title": "Güvenli Alışveriş",
  "why.secure.desc": "iyzico PCI-DSS altyapısı ve 256-bit SSL şifreleme. Kart bilgilerinize hiçbir zaman erişimimiz olmaz.",

  // Testimonials
  "testimonials.badge": "Müşteri Yorumları",
  "testimonials.title": "Onlar Söylüyor",

  // Newsletter CTA strip
  "cta.badge": "Özel Teklif",
  "cta.title": "İlk Siparişinde %10 İndirim",
  "cta.desc": "Bültenimize kaydol, hoş geldin indirim kodunu anında al.",
  "cta.placeholder": "E-posta adresin",
  "cta.button": "Kodumu Al",
  "cta.note": "İstediğin zaman çıkabilirsin. Spam yok, söz.",
};
...
const en: Record<string, string> = {
  ...
  "trust.printDesc": "Museum-quality pigment ink",
  "trust.return": "14-Day Returns",
  "trust.returnDesc": "No-questions-asked policy",
  "trust.shipping": "Free Shipping",
  "trust.shippingDesc": "On orders over 500 TL",
  "trust.secure": "Secure Checkout",
  "trust.secureDesc": "256-bit SSL, iyzico",

  // Why ComicWall
  "why.badge": "Why We're Different",
  "why.title": "Why ComicWall?",
  "why.desc": "We don't just sell posters. Every frame is an original artwork — museum-quality printed, safely packaged, and delivered to your door.",
  "why.ai.title": "Original AI Art",
  "why.ai.desc": "Every piece is uniquely generated by ComicWall using AI. No licensed characters, no copyright concerns.",
  "why.quality.title": "Museum-Quality Print",
  "why.quality.desc": "250gsm matte photo paper with pigment ink. Colors that last for years without fading.",
  "why.fast.title": "Fast Delivery",
  "why.fast.desc": "Ships within 1–2 business days of payment confirmation. Delivered to your door across Turkey.",
  "why.secure.title": "Secure Shopping",
  "why.secure.desc": "PCI-DSS certified iyzico infrastructure with 256-bit SSL. We never see your card details.",

  // Testimonials
  "testimonials.badge": "Customer Reviews",
  "testimonials.title": "What They're Saying",

  // Newsletter CTA strip
  "cta.badge": "Exclusive Offer",
  "cta.title": "10% Off Your First Order",
  "cta.desc": "Subscribe to our newsletter and get your welcome discount instantly.",
  "cta.placeholder": "Your email address",
  "cta.button": "Get My Code",
  "cta.note": "Unsubscribe anytime. No spam, we promise.",
};
