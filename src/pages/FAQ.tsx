...
const FAQ = () => {
  ...
  const groupsEn: FaqGroup[] = [
    {
      title: "Orders & Shipping",
      items: [
        {
          q: "When will my order be shipped?",
          a: "We hand over to courier within 1-2 business days after payment approval. Delivery takes 3-7 business days across Turkey. Shipping tracking number is sent to you via SMS and email.",
        },
        {
          q: "How much is the shipping fee?",
          a: `Standard shipping fee is ${formatPrice(SHIPPING.standardFee)}. Shipping is free on orders of ${formatPrice(SHIPPING.freeThreshold)} and above.`,
        },
        {
          q: "Which shipping carrier do you use?",
          a: "We work with Yurtiçi Kargo, Aras Kargo, and MNG Kargo. The most suitable carrier is automatically selected based on your region.",
        },
        {
          q: "How can I track my order?",
          a: "After signing in, you can see your order status and shipping tracking number on the 'My Orders' page.",
        },
      ],
    },
    {
      ...
      items: [
        {
          q: "What paper are the posters printed on?",
          a: "Our posters are printed on 250 gsm matte photo paper using museum-quality pigment ink. Colors are vibrant, details are sharp, and they are long-lasting.",
        },
        {
          q: "What sizes are available?",
          a: "All our posters are offered in three sizes: 10x15 cm, 13x18 cm, and 20x30 cm. The same size is preferred for collection sets.",
        },
        {
          q: "Do the posters come with frames?",
          a: "No, posters are shipped unframed. You can frame them according to your style or stick them directly to the wall.",
        },
        {
          q: "Are the designs original?",
          a: "Yes. All designs are originally generated by ComicWall using AI-assisted tools. No licensed characters or copyrighted materials are used.",
        },
      ],
    },
    {
      ...
      items: [
        {
          q: "Do I have a right of return?",
          a: "Yes. You have a right of unconditional return within 14 days from the delivery date. Simply contact our support team to initiate a return.",
        },
        {
          q: "What should I do if a damaged product arrives?",
          a: `Open the package in front of the courier and if there is damage, do not accept it; have them draft a report. Then contact us at ${SITE_CONFIG.email} with photos; we will provide a free replacement.`,
        },
        {
          q: "Can I make a size exchange?",
          a: "For exchanges, the current order is returned and refunded first, and then you need to create a new order in the correct size. Direct exchanges are not performed.",
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          a: "We accept all credit and debit cards through the iyzico infrastructure. Installment options may vary depending on your bank.",
        },
        {
          q: "Is my card information safe?",
          a: "Yes. Payments are processed through iyzico's PCI-DSS certified infrastructure with 256-bit SSL encryption. ComicWall never sees or stores your card details.",
        },
        {
          q: "Can I get an invoice?",
          a: "An e-archive invoice is generated for every order and is automatically sent to your email when completed. You can contact us for corporate invoice requests.",
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          a: "Sign-in is mandatory to simplify order tracking and speed up return/refund requests. Free registration takes only a few seconds.",
        },
        {
          q: "I forgot my password, what should I do?",
          a: "Click on the 'Forgot Password' link on the sign-in page to request a reset link to your email address.",
        },
        {
          q: "How do I delete my account?",
          a: `Simply send your account deletion request to ${SITE_CONFIG.email}. You can review our Privacy Policy page for your rights under KVKK/GDPR.`,
        },
      ],
    },
  ];

  const groups = isEn ? groupsEn : groupsTr;
